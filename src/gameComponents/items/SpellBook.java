...
public class SpellBook extends Staff{
    public SpellBook(String name, double price, String description, String subtype, Rarity rarity, int attack, int defense, int spellSlots, float durability, String element) {
